...
GUVI_Provided_queries = {
    "Find the top 10 highest revenue-generating products": 
        'select r2.product_id,sum(r2.sale_price * r2.quantity) as total_revenuefrom retail2 r2 join retail1 r1 on r2.order_id = r1.order_id group by r2.product_id order by total_revenue desc limit 10;',
